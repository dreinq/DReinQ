...
# trainSet = fvecs_read("data/SIFT/1M/sift_learn.fvecs")
# baseSet = fvecs_read("data/SIFT/1M/sift_base.fvecs")
# querySet = fvecs_read("data/SIFT/1M/sift_query.fvecs")
# gt = ivecs_read("data/SIFT/1M/sift_groundtruth.ivecs")
