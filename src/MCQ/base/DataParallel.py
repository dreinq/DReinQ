...
def parallel_apply(modules, funcName: str, inputs, kwargs_tup=None, devices=None):
...
class DataParallel(nn.DataParallel):
    ...
    def _parallelFnWrapper(self, func):
        ...
        def parallelApply(*inputs, **kwargs):
            ...
            outputs = parallel_apply(replicas, func.__name__, inputs, kwargs, self.device_ids[:len(replicas)])
